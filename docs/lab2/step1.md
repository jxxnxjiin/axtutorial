...
> 계약번호 / 계약명 / 계약 상대 / 계약기간 / 금액 / 자동갱신 여부
...
- [ ] 빈칸을 `0`으로 채우기 (금액 0원과 "금액 모름"은 다른 의미)
- [ ] 항목을 마음대로 더하거나 바꾸기
...
??? example "이렇게 시킬 수 있습니다"
    ```
    lab2 폴더의 계약서 8건을 전부 읽고, 한 계약당 한 줄로 lab2 폴더에 계약종합.xlsx로 정리해줘.
...
- [ ] 계약서에 적힌 항목은 모두 채워졌고, 원문에 없는 항목만 빈칸이다 (지어낸 값 없음)
