...
계약서 PDF를 하나 열어 보세요. 어디에도 표가 없는 줄글이고, 같은 금액도 '₩9,000,000'과 '금 구백만원정'처럼 문서마다 다르게 적혀 있습니다. AI는 이런 문서에서 항목을 뽑아 표로 만드는 일을 생각보다 빨리 해내지만, 함정이 있습니다 — 안 적힌 항목을 그럴듯하게 채워 넣는 것입니다. 그래서 뽑을 항목 6개를 못 박고 "없으면 비워둬"를 함께 넘겨, 계약서 8건을 한 계약 한 줄의 엑셀로 정리합니다.
