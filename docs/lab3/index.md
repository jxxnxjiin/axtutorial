...
이 실습에서 쓰는 업무 유형 — `자료 요약`(취합·통합) `분석하기`(집계·분석) `확인하고 수정하기`(검증·검수) · [여섯 가지 유형 다시 보기](../types/index.md)
...
쿠폰·이벤트를 뿌리기는 쉬워도 어떤 게 남는 장사였는지는 아무도 모르는 상황. 마케팅 부서에서 흔히 생기는 일입니다. [실습 1](../lab1/index.md)·[실습 2](../lab2/index.md)에서 배운 자료 요약으로 다섯 파일을 하나로 만들고, 이번에 새로 배우는 분석하기로 9천여 건의 데이터를 쿠폰 44줄로 줄입니다.
