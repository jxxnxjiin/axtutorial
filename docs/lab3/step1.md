...
채널 5곳에 따로 온 주문 기록을 하나의 엑셀 파일로 모읍니다. 취소 건도 지금은 그대로 두고, 어느 채널에서 왔는지만 표시합니다. (거르는 건 2단계 집계에서 합니다.)
