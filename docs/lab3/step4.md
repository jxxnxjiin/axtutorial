...
검산을 마친 표를 들고 가면 사수가 묻습니다. "그래서 이 쿠폰들, 왜 적자야?" 표만 봐서는 알 수 없습니다. 숫자는 '무엇'을 보여줄 뿐 '왜'는 안 알려주니, 이 단계에서는 표를 해석해 "어떤 쿠폰을 접고 뭘 밀지"까지 뽑아낼 것입니다.

조심할 것은 하나입니다. 생성형 AI는 그럴듯한 이유를 지어내는 것을 아주 잘합니다. 그래서 자료 안에서만 근거를 찾아, **숫자에 묶인 인사이트**를 도출하도록 해야 합니다.
