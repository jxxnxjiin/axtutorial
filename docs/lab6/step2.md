...
1단계에서 봐야 할 항목이 체크리스트로 나왔으니 이제 실제 검증입니다. 여기가 오늘의 핵심인데, 많은 사람이 "그냥 검토해 줘" 한 방으로 끝내려다 실수합니다 — 쓰레기를 넣으면 쓰레기가 나옵니다. 전체를 뭉쳐 시키지 말고 **관점을 나눠 독립적으로** 세 번 검증해야 결함이 제대로 걸립니다. 특히 틀린 건 눈에 띄지만 빠진 건 잘 안 보이니, 고객 관점에서 누락을 따로 훑습니다.
