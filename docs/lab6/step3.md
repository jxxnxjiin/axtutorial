...
그래서 세 관점의 문제를 1단계 체크리스트와 하나하나 대조해 종합한 뒤, **사실에 근거해 제안서를 다시 씁니다.** 틀린 값은 사양서 값으로, 근거 없는 빈칸은 지어내지 않고 '확인 필요'로 남깁니다.
...
??? example "이렇게 시킬 수 있습니다"
    ...
    고친 문장마다 어느 파일 근거인지 붙여주고, 결과는 lab6 폴더에 제안서_수정본.md로 저장해줘.
    ```
